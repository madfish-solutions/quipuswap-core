...
| Veto of (address)
| SetFirstFunctionsSet of (big_map(nat,(address * nat * dex_storage) -> (list(operation) * dex_storage)) * big_map(nat, (address * address * nat * nat * dex_storage) -> (list(operation) * dex_storage)))
