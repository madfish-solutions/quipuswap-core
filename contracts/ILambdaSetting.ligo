...
type full_dex_storage is record
  storage: dex_storage;
  initializeExchange: big_map(nat, (address * nat * dex_storage) -> (list(operation) * dex_storage));
...
| Veto of (address)
| SetFirstFunctionsSet of (address * nat * dex_storage) -> (list(operation) * dex_storage)


// | SetFirstFunctionsSet of (((address * nat * dex_storage) -> (list(operation) * dex_storage)) *( 
// (address * address * nat * nat * dex_storage) -> (list(operation) * dex_storage)) * 
// ((address * address * address * nat * nat * dex_storage) -> (list(operation) * dex_storage)) * 
// ((address * address * address * nat * nat * address * dex_storage) -> (list(operation) * dex_storage)))
