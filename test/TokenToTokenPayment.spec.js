...
contract("TokenToTokenPayment()", function () {
    it("should exchnge token to token and update dex state", function () {
        return __awaiter(this, void 0, void 0, function () {
            var context, tokenAmount, middleTezAmount, minTokensOut, firstDexContract, secondDexContract, aliceAddress, carolAddress, bobAddress, bobInitTezBalance, bobInitFirstTokenLedger, bobInitSecondTokenLedger, bobInitFirstTokenBalance, bobInitSecondTokenBalance, carolInitSecondTokenLedger, carolInitSecondTokenBalance, bobFinalTezBalance, bobFinalFirstTokenBalance, bobFinalSecondTokenLedger, bobFinalSecondTokenBalance, carolFinalSecondTokenBalance, firstPairTokenBalance, firstPairTezBalance, secondPairTokenBalance, secondPairTezBalance;
                ...
                switch (_a.label) {
                    ...
                    case 14:
                        ...
                        bobInitSecondTokenBalance = bobInitSecondTokenLedger
                            ...
                            : new bignumber_js_1["default"](0);
                        return [4 /*yield*/, context.tokens[1].storage.ledger[carolAddress]];
                    case 15:
                        carolInitSecondTokenLedger = _a.sent();
                        carolInitSecondTokenBalance = carolInitSecondTokenLedger
                            ? carolInitSecondTokenLedger.balance
                            : new bignumber_js_1["default"](0);
                        // swap tokens liquidity
                        return [4 /*yield*/, context.pairs[0].tokenToTokenPayment(tokenAmount, minTokensOut, secondDexContract, middleTezAmount, carolAddress)];
                    case 16:
                        // swap tokens liquidity
                        _a.sent();
                        return [4 /*yield*/, context.tezos.tz.getBalance(bobAddress)];
                    ...
                    case 20:
                        ...
                        return [4 /*yield*/, context.tokens[1].storage.ledger[bobAddress]];
                    case 21:
                        bobFinalSecondTokenLedger = _a.sent();
                        bobFinalSecondTokenBalance = bobFinalSecondTokenLedger
                            ? bobFinalSecondTokenLedger.balance
                            : new bignumber_js_1["default"](0);
                        return [4 /*yield*/, context.tokens[1].storage.ledger[carolAddress].balance];
                    case 22:
                        carolFinalSecondTokenBalance = _a.sent();
                    ...
                    case 26:
                        ...
                        assert_1.strictEqual(bobInitSecondTokenBalance.toNumber(), bobFinalSecondTokenBalance.toNumber(), "Sender tokens should stay the same");
                        assert_1.strictEqual(carolInitSecondTokenBalance.toNumber() + minTokensOut, carolFinalSecondTokenBalance.toNumber(), "Tokens not sent");
