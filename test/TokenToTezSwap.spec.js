...
contract("TokenToTezSwap()", function () {
    it("should exchnge token to tez and update dex state", function () {
        return __awaiter(this, void 0, void 0, function () {
            var context, tokenAmount, minTezOut, pairAddress, aliceAddress, bobAddress, bobInitTezBalance, bobInitTokenLedger, bobInitTokenBalance, operations, fees, bobFinalTezBalance, bobFinalTokenBalance, pairTokenBalance, pairTezBalance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 10:
                        ...
                        return [4 /*yield*/, context.pairs[0].tokenToTezSwap(tokenAmount, minTezOut)];
                    case 11:
                        operations = _a.sent();
                    ...
                    case 16:
                        ...
                        // 1. tez sent to user
                        assert_1.strictEqual(bobInitTezBalance.toNumber() + minTezOut - fees, bobFinalTezBalance.toNumber(), "Tez not received");
    ...
    it("should fail if min tez amount is too low", function () {
        return __awaiter(this, void 0, void 0, function () {
            var context, tokenAmount, minTezOut;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, assert_1.rejects(context.pairs[0].tokenToTezSwap(tokenAmount, minTezOut), function (err) {
    ...
    it("should fail if not enough tokens are approved", function () {
        return __awaiter(this, void 0, void 0, function () {
            var context, tokenAmount, minTezOut, aliceAddress;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, context_1.Context.init()];
                    case 1:
