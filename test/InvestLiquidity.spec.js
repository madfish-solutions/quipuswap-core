...
contract("InvestLiquidity()", function () {
    it("should invest liquidity and distribute new shares by current provider", function () {
        return __awaiter(this, void 0, void 0, function () {
            var context, tezAmount, tokenAmount, newShares, pairAddress, aliceAddress, aliceInitTezBalance, aliceInitTokenBalance, aliceFinalTezBalance, aliceFinalTokenBalance, pairTokenBalance, pairTezBalance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        // invest liquidity
                        return [4 /*yield*/, context.pairs[0].investLiquidity(tokenAmount, tezAmount, newShares)];
                    case 6:
                        // invest liquidity
                        _a.sent();
                        return [4 /*yield*/, context.tezos.tz.getBalance(aliceAddress)];
                    ...
                    case 12:
                        // 3. new pair state
                        _a.sent();
                        assert_1.strictEqual(context.pairs[0].storage.ledger[aliceAddress].balance.toNumber(), 1000 + newShares, "Alice should receive 1000 shares");
                        assert_1.strictEqual(context.pairs[0].storage.totalSupply.toNumber(), 1000 + newShares, "Alice tokens should be all supply");
    ...
    it("should invest liquidity and destribute new shares by new provider", function () {
        return __awaiter(this, void 0, void 0, function () {
            var context, tezAmount, tokenAmount, newShares, pairAddress, aliceAddress, bobAddress, bobInitTezBalance, bobInitTokenBalance, bobFinalTezBalance, bobFinalTokenBalance, pairTokenBalance, pairTezBalance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.timeout(5000000);
                    ...
                    case 17:
                        // 3. new pair state
                        _a.sent();
                        assert_1.strictEqual(context.pairs[0].storage.ledger[bobAddress].balance.toNumber(), newShares, "Alice should receive 1000 shares");
                        assert_1.strictEqual(context.pairs[0].storage.totalSupply.toNumber(), 1000 + newShares, "Alice tokens should be all supply");
                        assert_1.strictEqual(context.pairs[0].storage.tezPool.toNumber(), 10000 + tezAmount, "Tez pool should be fully funded by sent amount");
                        assert_1.strictEqual(context.pairs[0].storage.tokenPool.toNumber(), 1000000 + tokenAmount, "Token pool should be fully funded by sent amount");
                        assert_1.strictEqual(context.pairs[0].storage.invariant.toNumber(), (1000000 + tokenAmount) * (10000 + tezAmount), "Inveriant should be calculated properly");
    ...
    it("should fail investment if min shares are too low", function () {
        return __awaiter(this, void 0, void 0, function () {
            var context, tezAmount, tokenAmount, newShares;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, assert_1.rejects(context.pairs[0].investLiquidity(tokenAmount, tezAmount, newShares), function (err) {
    ...
    it("should fail investment if min shares are too high", function () {
        return __awaiter(this, void 0, void 0, function () {
            var context, tezAmount, tokenAmount, newShares;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    it("should fail investment if too little tez are sent", function () {
        return __awaiter(this, void 0, void 0, function () {
            var context, tezAmount, tokenAmount, newShares;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    it("should fail investment if too little tokens are sent", function () {
        return __awaiter(this, void 0, void 0, function () {
            var context, tezAmount, tokenAmount, newShares;
            return __generator(this, function (_a) {
                switch (_a.label) {
